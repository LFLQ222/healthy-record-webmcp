...
| Tool | Tipo | Comportamiento |
|---|---|---|
| `highlight_findings` | read | Marca valores fuera de rango en la vista. Barato y muy visual |
| `order_lab_panel` | write | Orden de laboratorio con confirmación explícita |
