...
const vital = (
  ...
  id,
  recordedAt: `${recordedAt}T10:30:00Z`,
  createdAt: `${recordedAt}T10:30:00Z`,
  updatedAt: `${recordedAt}T10:30:00Z`,
  createdBy: doctorRef,
  ...v,
});
...
const note = (
  ...
  status: 'SIGNED',
  title,
  createdAt: `${createdAt}T11:05:00Z`,
  signedAt: `${createdAt}T11:20:00Z`,
  revision: 1,
  author: DOCTOR_MIN,
  subjective: soap.s,
  objective: soap.o,
